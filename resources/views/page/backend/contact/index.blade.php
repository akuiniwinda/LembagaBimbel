                            ...
                            <table class="table text-nowrap mb-0 align-middle">
                                <thead class="text-dark fs-4">
                                    <tr>
                                        ...
                                        <th class="border-bottom-0">
                                            <h6 class="fw-semibold mb-0">Status (Dilihat?)</h6>
                                        </th>
                                        <th class="border-bottom-0">
                                ...
                                <tbody>
                                    @foreach ($contacts as $kontak)
                                        <tr>
                                            ...
                                            <td class="border-bottom-0">
                                                <!-- Badge status dinamis: Auto-update dari detail -->
                                                @if($kontak->is_active)
                                            ...
                                            <td class="border-bottom-0">
                                                <div class="d-flex align-items-center gap-2">
                                                    <a class="badge bg-primary rounded-3 fw-semibold" href="/adminpanel/contact/show/{{$kontak->id}}">Detail</a>
